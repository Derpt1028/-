        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <%
                    ...
                    Cookie[] cookies=request.getCookies();//获取用户名和Email的Cookie
                    String Username="未登录用户";//暂时未登录
                    String email="";//初始化用户的邮箱信息
                    if(cookies!=null){
...
//                break;
                            ...
                            if("UEmail".equals(name)){
                                //获取Cookie的value
                                email=cookie.getValue();
                                //URL解码
                                email=URLDecoder.decode(email,"utf-8");
                            }
                            if(!email.equals("")&&!Username.equals("未登录用户")){
                                break;//满足条件就可以跳出循环
                            }
                        }
